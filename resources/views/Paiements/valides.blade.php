...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
            <p class="text-gray-600 mt-1">Paiements validés</p>
        </div>
        <div class="mt-4 md:mt-0">
            <div class="flex items-center space-x-4">
                <div class="text-sm text-gray-600">
                    <span id="archiveCount">{{ $paiements->total() }}</span> paiements validés
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
            ...
            <div class="archive-card bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col h-full">
                <div class="p-4 flex-1 flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        <!-- Statut -->
                        <span class="status-badge bg-green-50 text-green-700 text-xs px-2 py-1 rounded inline-block mt-2">
                            <b>Payé</b>
                        </span>
                        ...
                        <div class="mt-3 text-sm">
                            ...
                            <div class="flex justify-between mt-2">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-gray-900">0 F CFA</p>
                                </div>
                            </div>
                        </div>

                        <p class="text-xs text-green-600 mt-2">
                            Paiement totalement effectué et validé
                        </p>
                    </div>
                    ...
                    <div class="mt-3 flex flex-wrap items-center justify-between gap-4 border-t border-gray-100 pt-3">
                        ...
                        <div class="flex items-center">
                            <span class="text-xs font-medium text-gray-400">Aucune action requise</span>
                        </div>
                    </div>
        ...
        @empty
            <div class="col-span-4 text-center py-12">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Aucun paiement validé</h3>
                <p class="text-gray-500">Tous les paiements sont soit en cours, partiels, soit non initiés.</p>
            </div>
        @endforelse
    </div>
