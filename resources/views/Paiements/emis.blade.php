            ...
            <div class="archive-card bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden cursor-pointer hover:shadow-md transition-shadow flex flex-col h-full">
                <div class="p-4 flex-1 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex justify-between items-center mb-3">
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ number_format($p->montant_a_payer, 0, ',', ' ') }} F CFA</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Déjà payé</p>
                                <p class="text-sm font-semibold text-gray-900">{{ number_format($p->montant_deja_paye, 0, ',', ' ') }} F CFA</p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Restant</p>
                                <p class="text-sm font-semibold text-gray-900">{{ number_format($p->montant_restant, 0, ',', ' ') }} F CFA</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 flex flex-wrap items-center justify-between gap-4 border-t border-gray-100 pt-3">
                        ...
                        <div>
                            <p class="text-xs text-gray-500">Versements effectués</p>
                            <p class="text-sm font-semibold text-gray-900">{{ $nombreVersements }}</p>
                        </div>
