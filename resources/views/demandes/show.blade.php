...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
            <button id="rejectBtn" class="flex-1 px-6 py-3 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors flex items-center justify-center">
                <i class="fas fa-times-circle mr-2"></i> Refuser
            </button>
            <button id="acceptBtn" class="flex-1 px-6 py-3 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors flex items-center justify-center">
    ...
    <!-- Action Buttons -->
        ...
        <div id="rejectCommentSection" class="mt-6 hidden">
            ...
            <textarea id="rejectComment" rows="4" placeholder="Veuillez expliquer le motif de votre refus..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors resize-none"></textarea>
            <div class="mt-4 flex space-x-4">
                <button id="confirmRejectBtn" class="px-6 py-3 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors">Confirmer le refus</button>
                <button id="cancelRejectBtn" class="px-6 py-3 bg-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-400 transition-colors">Annuler</button>
            </div>
        </div>
    </div>
</main>
