        ...
        <div class="mt-4 md:mt-0">
            <div class="flex items-center space-x-4">
                <div class="text-sm text-gray-600">
                    <span id="archiveCount">{{ $demandes->total() }}</span> demandes
                </div>
            </div>
        </div>
    </div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
    ...
    <!-- Création -->
            ...
            <span>Créée le :</span>
            <span class="text-gray-900">{{ $a->created_at?->format('d/m/Y H:i') }}</span>
              </div>
    ...
    <div class="flex flex-col text-xs text-gray-500">
        ...
        <span class="text-gray-900">
            {{ $a->date_validation_controleur?->format('d/m/Y H:i') ?? 'Non validée' }}
        </span>
    </div>
    ...
    <div class="flex flex-col text-xs text-gray-500">
        ...
        <span class="text-gray-900">
            {{ $a->date_validation_daf?->format('d/m/Y H:i') ?? 'Non validée' }}
        </span>
    </div>
    ...
    <div class="flex flex-col text-xs text-gray-500">
        ...
        <span class="text-gray-900">
            {{ $a->date_validation_dg?->format('d/m/Y H:i') ?? 'Non validée' }}
        </span>
    </div>

    <!-- Lien détails -->
    <div class="flex items-center">
        <a href="{{ route('demandes.show', $a->id) }}" 
    ...
    @empty
        <div class="col-span-4 text-center py-12">
            ...
            <p class="text-gray-500">Il n’y a actuellement aucune demande enregistrée.</p>
        </div>
    @endforelse
</div>
