...
<head>
    ...
    <title>Versement validé - {{ $paiement->demande->reference_dp }}</title>
...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <p class="text-gray-700 mb-6">
            Le Directeur Général a validé un versement lié à cette demande de paiement.
        </p>

        <!-- DETAILS -->
        <div class="mb-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4 border-b pb-2">
                Détails du versement validé
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <p><strong>Montant validé :</strong>
