    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="mb-8">
                ...
                <p class="text-gray-700 mb-4">
                    Votre demande de paiement a été refusée par le DAF de votre entité.
                </p>
            </div>
            ...
            <div>
                <p class="text-gray-700 mb-4">
                    Pour toute question, veuillez contacter votre contrôleur :
                    <strong>{{ $controleur->prenom ?? 'Contrôleur' }} {{ $controleur->nom ?? '' }}</strong>
                </p>
                <p class="text-gray-700 mb-4">
                    Cordialement,
                </p>
                <p class="text-gray-700">L’équipe DPaie</p>
            </div>
        </div>
