...
<head>
    ...
    <title>Demande refusée - {{ $demande->entite->libelle_entite ?? '-' }} - {{ $demande->reference_dp }}</title>
...
<body class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Demande refusée par le Directeur</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-gray-700 mb-4">
                Votre demande de paiement a été refusée par le Directeur.
            </p>

            <!-- Demande details -->
            <h2 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-gray-200">Informations de la demande</h2>
            ...
            <!-- Description -->
            <div class="mt-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-2">Objet de la dépense</h2>
                <p class="text-gray-700">{{ $demande->description ?? '-' }}</p>
            </div>

            <!-- Closing -->
            <div class="mt-6">
                <p class="text-gray-700 mb-4">Nous vous invitons à consulter la demande dans l’application pour plus de détails.</p>
                <p class="text-gray-700 mb-4">Cordialement,</p>
                <p class="text-gray-700 font-medium">L’équipe DPaie</p>
            </div>
        </div>
